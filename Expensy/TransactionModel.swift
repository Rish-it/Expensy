...
struct Transaction: Identifiable, Decodable, Hashable {
    ...
    var icon: FontAwesomeCode {
        if let category = Category.all.first(where: { $0.id == categoryld }) {
...
extension Category {
    ...
    static let rent = Category(id: 601, name: "Rent", icon: .house_user, mainCategoryId: 5)
    static let homesupplies = Category(id: 602, name: "Home", icon: .house_user, mainCategoryId: 6)
    static let homeSupplies = Category(id: 701, name: "Home Supplies", icon: .lightbulb, mainCategoryId: 6)
    static let paycheque = Category(id: 702, name: "Paycheque", icon: .rupee_sign, mainCategoryId: 7)
